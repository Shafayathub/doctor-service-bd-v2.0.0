...
const Colorectal = () => {
  ...
  const colorectalDoctor = doctors.filter((doctor) =>
    doctor.speciality.toLowerCase().includes('colorectal')
  );
  return (
    <>
      <Head>
        <title>Colorectal | Doctor | Doctor Service BD</title>
        <meta
          name="description"
