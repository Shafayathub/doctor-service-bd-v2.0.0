...
const Diabetes = () => {
  ...
  const diabetesDoctor = doctors.filter((doctor) =>
    doctor.speciality.toLowerCase().includes('diabetes')
  );
  return (
    <>
      <Head>
        <title>Diabetes | Doctor | Doctor Service BD</title>
        <meta
          name="description"
