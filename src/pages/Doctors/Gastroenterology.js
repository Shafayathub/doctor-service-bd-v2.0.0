...
const Gastroenterology = () => {
  ...
  const gastroenterologyDoctor = doctors.filter((doctor) =>
    doctor.speciality.toLowerCase().includes('gastroenterology')
  );
  return (
    <>
      <Head>
        <title>Gastroenterology | Doctor | Doctor Service BD</title>
        <meta
          name="description"
      ...
      <main className="min-h-screen p-5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
          {gastroenterologyDoctor.map((doctor) => (
