...
const Kidney = () => {
  ...
  const kidneyDoctor = doctors.filter((doctor) =>
    doctor.speciality.toLowerCase().includes('kidney')
  );
  return (
    <>
      <Head>
        <title>Kidney | Doctor | Doctor Service BD</title>
        <meta
          name="description"
