...
const Neurology = () => {
  ...
  const neurologyDoctor = doctors.filter((doctor) =>
    doctor.degree.toLowerCase().includes('neurology')
  );
  return (
    <>
      <Head>
        <title>Neurology | Doctor | Doctor Service BD</title>
        <meta
          name="description"
