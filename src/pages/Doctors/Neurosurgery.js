...
const Neurosurgery = () => {
  ...
  const neurosurgeryDoctor = doctors.filter((doctor) =>
    doctor.degree.toLowerCase().includes('neurosurgery')
  );
  return (
    <>
      <Head>
        <title>Neurosurgery | Doctor | Doctor Service BD</title>
        <meta
          name="description"
