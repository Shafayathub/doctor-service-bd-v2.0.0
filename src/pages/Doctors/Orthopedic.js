...
const Orthopedic = () => {
  ...
  const orthopedicDoctor = doctors.filter((doctor) =>
    doctor.speciality.toLowerCase().includes('orthopedic')
  );
  return (
    <>
      <Head>
        <title>Orthopedic | Doctor | Doctor Service BD</title>
        <meta
          name="description"
