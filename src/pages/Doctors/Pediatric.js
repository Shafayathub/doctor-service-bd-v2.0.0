...
const Pediatric = () => {
  ...
  const pediatricDoctor = doctors.filter((doctor) =>
    doctor.speciality.toLowerCase().includes('pediatric')
  );
  return (
    <>
      <Head>
        <title>Pediatric | Doctor | Doctor Service BD</title>
        <meta
          name="description"
