...
const Psychiatry = () => {
  ...
  const psychiatryDoctor = doctors.filter((doctor) =>
    doctor.degree.toLowerCase().includes('psychiatry')
  );
  return (
    <>
      <Head>
        <title>Psychiatry | Doctor | Doctor Service BD</title>
        <meta
          name="description"
