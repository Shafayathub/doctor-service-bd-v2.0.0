...
const Sexual = () => {
  ...
  const sexualDoctor = doctors.filter((doctor) =>
    doctor.speciality.toLowerCase().includes('sexual')
  );
  return (
    <>
      <Head>
        <title>Sexual | Doctor | Doctor Service BD</title>
        <meta
          name="description"
