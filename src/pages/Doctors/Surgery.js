...
const Surgery = () => {
  ...
  const surgeryDoctor = doctors.filter((doctor) =>
    doctor.degree.toLowerCase().includes('surgery')
  );
  return (
    <>
      <Head>
        <title>Surgery | Doctor | Doctor Service BD</title>
        <meta
          name="description"
